...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::delete('/delete/{id}', 'App\Http\Controllers\AdminController@delete')->name('codeTemplate.delete');
    ...
    Route::get('/orders/{payment_id}', 'App\Http\Controllers\AdminController@orderDetails')->name('orders.details');
});
...
Route::get('/locale/{locale}', 'App\Http\Controllers\LangController@setLocale')->name('lang.locale');
